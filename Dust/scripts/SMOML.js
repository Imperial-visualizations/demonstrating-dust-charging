...
function SMOML_produce_surface_potenial_plot(){//produce data for fresnel curves
    ...
    let sp_line_H = {
        ...
        y: data_H,
        type: 'scatter',
        name: 'SMOML: Norm Surface potential, u = ' + u.toString(),
    };
...
function SOML_produce_surface_potenial_plot(){//produce data for fresnel curves
    ...
    let sp_line_H = {
        ...
        y: data_H,
        type: 'scatter',
        name: 'SOML: Norm Surface potential, u = ' + u.toString(),
    };
    plot_data.push(sp_line_H);
...
function MOML_produce_surface_potenial_plot(){//produce data for fresnel curves
    ...
    let sp_line_H = {
        ...
        y: data_H,
        type: 'scatter',
        name: 'MOML: Norm Surface potential Gamma = ' + gamma.toString(),
    };
...
function SMOML_produce_surface_potenial_plot_u(){//produce data for fresnel curves
    ...
    let sp_line_H = {
        ...
        y: data_H,
        type: 'scatter',
        name: 'SMOML: Norm Surface potential, beta = ' + beta.toString() + ", Gamma =" + gamma.toString(),
    };
    plot_data.push(sp_line_H);
...
function SOML_produce_surface_potenial_plot_u(){//produce data for fresnel curves
    ...
    let sp_line_H = {
        ...
        y: data_H,
        type: 'scatter',
        name: 'SOML: Norm Surface potential, beta = ' + beta.toString(),
    };
    plot_data.push(sp_line_H);
